...
const SkeletonCard = () => (
    <div className="bg-brand-surface rounded-xl border border-brand-border p-6 animate-pulse">
        <div className="flex justify-between items-start mb-4">
            <div className="h-6 w-16 bg-brand-bg rounded-md"></div>
            <div className="h-6 w-20 bg-brand-bg rounded-md"></div>
        </div>
        <div className="h-6 w-3/4 bg-brand-bg rounded mb-3"></div>
        <div className="h-4 w-full bg-brand-bg rounded mb-2"></div>
        <div className="h-4 w-2/3 bg-brand-bg rounded mb-6"></div>
        <div className="flex justify-between items-center pt-4 border-t border-brand-border/50">
            <div className="h-4 w-24 bg-brand-bg rounded"></div>
            <div className="h-9 w-20 bg-brand-bg rounded-lg"></div>
        </div>
    </div>
);
